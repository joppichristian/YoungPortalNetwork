...
<body>
  ...
  <div style="width:100%;height:100px; background-color:rgb(148,59,68); padding:25px;" align="center">
    <div style="color:white;"><a href="index.html" style="color:white;">Comune di Giovo</a></div>
...
<div class="cd-tabs">
	<nav>
		<ul class="cd-tabs-navigation">
			<li><a data-content="inbox" class="selected" href="#0">Sale civiche</a></li>
	...
	<ul class="cd-tabs-content">
		<li data-content="inbox" class="selected">
			<p>CHIEDE sala civica comunale di :</p>
			<p>* Valternigo</p>
			<p>* Ville</p>
      <p>* Mosana</p>

			<p><a href="../document_structure/giovo/A.pdf" download>scarica modulo <i class="fa fa-download"></i></a></p>
