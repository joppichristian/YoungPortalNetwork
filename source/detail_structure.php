...
<body>
  ...
  <div style="width:100%;height:100px; background-color:rgb234,140,6); padding:25px;" align="center">
...
<div class="cd-tabs">
	<nav>
		<ul class="cd-tabs-navigation">
			<li><a data-content="inbox" class="selected" href="#0">Teatro</a></li>
			<li><a data-content="new" href="#0">Strutture comunali</a></li>
			<li><a data-content="gallery" href="#0">Attrezzatura</a></li>
			<li><a data-content="store" href="#0">Palchi</a></li>
			<li><a data-content="settings" href="#0">Baite</a></li>
			<li><a data-content="trash" href="#0">Masi</a></li>
