...
<body>
  ...
  <div style="width:100%;height:100px; background-color:rgb(234,140,6); padding:25px;" align="center">
    <div style="color:white;"><a href="index.html" style="color:white;">Comune di Lona-Lases</a></div>
...
<div class="cd-tabs">
	<nav>
		<ul class="cd-tabs-navigation">
			<li><a data-content="inbox" class="selected" href="#0">Sale pubbliche</a></li>
	...
	<ul class="cd-tabs-content">
      ...
      <p>CHIEDE il nulla osta per l’utilizzo di una delle sale pubbliche comunali :</p>
      <p>Centro sociale di Lona:</p>
      	<p>   * Sala Teatro</p>
        <p>   * Mansarda</p>
        <p>   * Sala riunioni</p>
        <p>   * Sala ex caldaia</p>
			...
			<p>Canonica Lona:</p>
        <p>   * Locale primo piano</p>
      <p>Scuole elementari:</p>
        <p>   * Sala Teatro</p>
        <p>   * Mansarda</p>
      <p>* Ludoteca(ex mensa)</p>
      <p>* Municipio</p>
      <p><a href="../document_structure/lona-lases/A.pdf" download>scarica modulo <i class="fa fa-download"></i></a></p>
		</li>
