...
?>
<head>
  <title>YPN | Aggiungi Azienda</title>
  <meta charset="utf-8">
		...
		<form id="submitForm" name="submitForm" onsubmit="return validateForm();" method="post"  enctype="multipart/form-data" > 
		  ...
		  <h3>------------------------------------------------------------------------------------</h3>
			...
			<table border="1">
				<tr> <td>   </td> <td>   </td> </tr>
				<?php
				$query_foto="SELECT * FROM MEDIA_AZIENDA WHERE TIPO='FOTO' AND AZIENDA_ID='".$id_companies."' ;" ;
