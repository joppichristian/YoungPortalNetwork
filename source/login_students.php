...
<body>
	<header role="banner" style="background-color:black;">
		<div id="cd-logo"><a href="index.html"><a href="index.html"><i  class="fa fa-chevron-left"></i> TORNA ALLA HOME</a></div>
    ...
    <!--include la pagina -->
  <object type="text/html" data="students_big.html" style="width:100%; height:100%">
    <p>backup content</p>
  </object>
